...
export default {
    ...
    setup() {
        window.onscroll = function () {
            ...
            console.log(document.body.scrollHeight); // body 全高度 (精度较差)

            console.log(document.documentElement.clientHeight); // 内高度, 不包括水平滚动条 边框 和 外边距 高度 (执行四舍五入)
            console.log(
                document.documentElement.getBoundingClientRect().height
            ); // html 全高度 (最为精准)
            console.log(document.body.getBoundingClientRect().height); // body 全高度 (最为精准)
