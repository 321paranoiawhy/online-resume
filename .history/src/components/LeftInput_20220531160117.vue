    ...
    setup() {
        ...
        let changeTheme = () => {
            ...
            // moon 黑夜
                ...
                // TODO svg 图片颜色更改
                document.querySelectorAll("img")[0].style.filter =
                    "invert(100%) sepia(0%) saturate(7482%) hue-rotate(198deg) brightness(111%) contrast(104%)";
                document
                    .querySelectorAll("img")
                    .forEach(
                        (item) =>
                            (item.style.filter =
                                "invert(100%) sepia(0%) saturate(0%) hue-rotate(217deg) brightness(107%) contrast(101%)")
                    );
            }
        };
        let input = ref(null);
