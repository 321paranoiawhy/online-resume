    ...
    setup() {
        ...
        let Fn = (parameter) => {
            switch (parameter) {
                ...
                // 后两页
                case "nextDoublePage":
                    // currentInputPage 不小于 totalInputPage - 2, 不予处理
                    // 小于 totalInputPage - 2, 则 +=2
                    if (currentInputPage.value < totalInputPage.value - 2) {
                        currentInputPage.value += 2;
                    }
                    console.log(currentInputPage.value);
                    break;
