    ...
    <div class="right-output-flex-column">
        <div class="top-flex">
            ...
            <div class="dropdown-menu">
                <div class="initial">Template 1</div>
                <div class="dropdown-content">
                    <div class="hover" @click="exchange(0)">Template 2</div>
                    <div class="hover" @click="exchange(1)">Template 3</div>
                    <div class="hover" @click="exchange(2)">Template 4</div>
                    <div class="hover" @click="exchange(3)">Template 5</div>
                    <div class="hover" @click="exchange(4)">Template 6</div>
                </div>
            </div>
            <div class="dropdown-menu">
                <div class="initial">EN</div>
                <div class="dropdown-content">
                    <div class="hover" @click="exchange(0)">CN</div>
                </div>
            </div>
            <!-- 快速跳转至某行某列 (默认当前页) -->
