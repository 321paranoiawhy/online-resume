...
export default {
    ...
    setup() {
        ...
        let compileInput = () => {
            ...
            // }
            if (selfEvaluationMatch) {
                if (selfEvaluationMatch.length <= 3) {
                    for (let i = 0; i < 3; i++) {
                        if (i < selfEvaluationMatch.length) {
                            document.querySelector(
                                "ul.selfEvaluation"
                            ).children[i].innerHTML = selfEvaluationText[
                                i
                            ...
                            switch (i) {
                                ...
                                case 1:
                                    document.querySelector(
                                        ...
                                        "Code carefully and cautiously";
                                    break;
                                case 2:
                                    document.querySelector(
                                        "ul.selfEvaluation"
                                    ).children[i].innerHTML =
                                        "Devoted to Front-End and learn quickly";
                                    break;
                                default:
                                    break;
                            }
                        ...
                        //     i
                        // ].innerHTML = selfEvaluationText[i].slice(
                        //     "*self-evaluation: ".length
                        // );
                    }
                    // for (let i = 0; i < selfEvaluationMatch.length; i++) {
                    ...
                    // 填充 缺失的 li
                    // for (
                    //     let i = selfEvaluationMatch.length;
                    //     i <
                    //     document.querySelector("ul.selfEvaluation").children
                    //         .length;
                    //     i++
            ...
            // if (
            //     selfEvaluationMatch.length <=
            //     document.querySelector("ul.selfEvaluation").children.length
            // ) {
            //     for (let i = 0; i < selfEvaluationMatch.length; i++) {
            //         document.querySelector("ul.selfEvaluation").children[
            //             i
