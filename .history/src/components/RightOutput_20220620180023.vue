        ...
        <div class="top-flex">
            ...
            <div class="dropdown-menu">
                ...
                <div class="dropdown-content">
                    <div class="hover template" @click="exchange(0)">
                        Template 2
                    </div>
                    <div class="hover template" @click="exchange(1)">
                        Template 3
                    </div>
                    <div class="hover template" @click="exchange(2)">
                        Template 4
                    </div>
                    <div class="hover template" @click="exchange(3)">
                        Template 5
                    </div>
                    <div class="hover template" @click="exchange(4)">
                        Template 6
                    </div>
                </div>
            </div>
