    ...
    <div class="right-output-flex-column">
        <div class="top-flex">
            ...
            <div class="dropdown-menu">
                <div class="initial template">Template 1</div>
                <div class="dropdown-content">
                    <div class="hover template" @click="changeTemplate(0)">
                        Template 2
                    </div>
                    <div class="hover template" @click="changeTemplate(1)">
                        Template 3
                    </div>
                    <div class="hover template" @click="changeTemplate(2)">
                        Template 4
                    </div>
                    <div class="hover template" @click="changeTemplate(3)">
                        Template 5
                    </div>
                    <div class="hover template" @click="changeTemplate(4)">
                        Template 6
                    </div>
                </div>
            </div>
            <!-- 更换语言 EN / CN -->
            <div class="dropdown-menu">
                <div class="initial language">EN</div>
                <div class="dropdown-content">
                    <div class="hover language" @click="changeLanguage(0)">
                        CN
                    </div>
                </div>
            </div>
...
export default {
    ...
    setup() {
        ...
        let changeLanguage = (index) => {
            // 互换 innerHTML
            // temp = A    A = B    B = temp
            let temp = document.querySelector("div.initial").innerHTML;
            document.querySelector("div.initial").innerHTML =
                document.querySelector("div.dropdown-content").children[
                    index
                ].innerHTML;
            document.querySelector("div.dropdown-content").children[
                index
