        ...
        let Fn = (parameter) => {
            switch (parameter) {
                case "download":
                    ...
                    // offsetLeft 和 offsetTop 是相对于父节点的偏移量
                    // offsetWidth 和 offsetHeight 是相对于父节点的宽高
                    // https://juejin.cn/post/6844903824138698759
                    (async () => {
                        ...
                        //     height: 800,
                        // });
                        await page.goto("window.location.href", { waitUntil }); // 打开页面
