        ...
        <div class="top-flex">
            <div class="center">
                ...
                <img
                    ...
                    @click="Fn(item.function)"
                />
                <!-- v-if v-else 存在图片颜色未能更改的问题, 尚待解决, 因而改用 v-show -->
                <img
                    v-if="sunOrMoon"
                    ...
                    @click="changeTheme()"
                />
                <img v-else style="style="filter: invert(99%) sepia(1%)
                saturate(335%) hue-rotate(174deg) brightness(99%)
                contrast(95%);"" src="../assets/images/IconoirHalfMoon.svg"
                alt="IconoirHalfMoon" @click="changeTheme()" />
                <!-- v-show -->
                <!-- <img
                    v-show="sunOrMoon"
                    src="../assets/images/IconoirSunLight.svg"
