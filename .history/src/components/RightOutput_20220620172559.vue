        ...
        <div class="top-flex">
            ...
            <div class="dropdown-menu">
                ...
                <div class="dropdown-content">
                    <div class="hover" @click="exchange('CN', 0)">CN</div>
                </div>
            </div>
            <!-- 快速跳转至某行某列 (默认当前页) -->
...
export default {
    ...
    setup() {
        ...
        // function exchange(parameter) {
        //     console.log(parameter);
        //     document.querySelector("div.initial").innerHTML = parameter;
        // }
        let exchange = (string, index) => {
            // console.log(document.querySelector("div.dropdown-content")).children[index].innerHTML = string;
            document.querySelector("div.dropdown-content").children[
                index
            ].innerHTML = document.querySelector("div.initial").innerHTML;
            document.querySelector("div.initial").innerHTML = string;
        };
        return {
            rightOutputImage,
            currentOutputPage,
