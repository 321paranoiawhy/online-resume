...
export default {
    ...
    setup() {
        window.onscroll = function () {
            ...
            console.log(document.body.scrollHeight); // body 全高度
            console.log(document.body.getBoundingClientRect().height); // body 全高度
            // console.log(document.querySelector(".textarea.left-textarea"));
            // output.value.$el.offsetTop = window.scrollY;
            output.value.$el.style.position = "fixed";
            // output.value.$el.style.top =
            //     output.value.$el.offsetTop-window.scrollY + (1583.4 - 1122.52) + "px";
            output.value.$el.style.top =
                ((-document.body.scrollHeight + 1122.52 - 60) *
                    window.scrollY) /
                    scrollMaxY +
                60 +
                "px";
            // output.value.$el.style.top =
            //     -document.body.scrollHeight + 1122.52 + "px";
            // output.value.$el.style.left = left + "px";
            // if (top > 0 && window.scrollY > top) {
            //     output.value.$el.style.position = "fixed";
            //     output.value.$el.style.top = "-30px";
            //     // output.value.$el.style.bottom = "0px";
            //     output.value.$el.style.left = left + "px";
            //     // // console.log(output.value.$el.offsetHeight);
            //     console.log("111");
            //     console.log(top);
            // } else {
            //     console.log(top);
            ...
            //     output.value.$el.removeAttribute("style");
            //     console.log("111");
            // } else if (top <= window.scrollY < 2 * top) {
            //     output.value.$el.style.position = "fixed";
            //     output.value.$el.style.top = "0px";
            //     output.value.$el.style.bottom = "";
            //     output.value.$el.style.left = left + "px";
            //     console.log("222");
            // } else {
            //     output.value.$el.style.position = "fixed";
            ...
            //     // output.value.$el.style.left = left + "px";
            // } else {
            //     // output.value.$el.scrollIntoView(false);
            //     output.value.$el.removeAttribute("style");
            // }
            // console.log(window.innerWidth, window.innerHeight); // 1556 1002
